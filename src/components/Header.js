    ...
    <header className="d-flex justify-between align-center p-40">
      <Link to="/">
        <div className="d-flex align-center">
          <img className="ml-15" width={40} height={40} src="/img/logo.png" alt="sss"/>
          <div>
      ...
      <ul className="d-flex ">
        <li onClick={props.onClickCart} className="mr-10 cu-p">
          <img className="mr-10" 
            width={17} height={17} src="/img/cart.svg" alt="Корзина" />
          <span>{totalPrice}: руб.</span>          
        </li >

        <li className="mr-10">
          <Link to="/favorites">
            <img src="/img/favoriteBtnHeader.svg" alt="Закладки"/>
          </Link>
        </li>
